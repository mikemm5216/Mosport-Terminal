...
async function deploy() {
  const assets = [
    ...
    { name: 'sf.png', url: 'https://a.espncdn.com/i/teamlogos/mlb/500/sf.png' },
    { name: 'sea.png', url: 'https://a.espncdn.com/i/teamlogos/mlb/500/sea.png' },
    { name: 'tex.png', url: 'https://a.espncdn.com/i/teamlogos/mlb/500/tex.png' },
    { name: 'chw.png', url: 'https://a.espncdn.com/i/teamlogos/mlb/500/chw.png' }
  ];
