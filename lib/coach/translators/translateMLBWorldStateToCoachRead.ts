...
export function translateMLBWorldStateToCoachRead(worldState: WorldEngineState): CoachReadDTO {
  ...
  return {
    ...
    isPregameOnly: true,
    homeTeam: { id: worldState.homeTeam.id, name: worldState.homeTeam.name, shortName: worldState.homeTeam.shortName || worldState.homeTeam.id, league: "MLB" },
    awayTeam: { id: worldState.awayTeam.id, name: worldState.awayTeam.name, shortName: worldState.awayTeam.shortName || worldState.awayTeam.id, league: "MLB" },
