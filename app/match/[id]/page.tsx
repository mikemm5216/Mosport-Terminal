   ...
   return (
      <div className="max-w-5xl mx-auto pt-10 pb-20 px-4 min-h-screen">
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="border border-gray-800 bg-[#0B0D13] p-8 text-center rounded">
            ...
            <div className="border border-gray-800 bg-[#0B0D13] p-8 text-center rounded">
               <div className="text-sm text-slate-400 uppercase tracking-widest mb-3 font-bold">Historical Logs</div>
