Fix build errors by creating missing UI components.

Create the following files inside / components:

1. SignalPanel.tsx
2. SkeletonLoader.tsx
3. DisclaimerModal.tsx

Each component should be a minimal functional React component.
...
Also standardize import paths:

Use "@/components/..." instead of relative paths.

If alias "@" is not configured, configure it in tsconfig.json:
