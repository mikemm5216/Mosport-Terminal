      ...
      <div className="min-h-screen bg-[#05090f] text-slate-200 font-sans selection:bg-cyan-500/30 overflow-x-hidden pb-40">
            ...
            <div className="max-w-7xl mx-auto h-14 flex items-center justify-between">
               <div className="flex items-center gap-10">
                  <div className="flex items-center gap-3">
                     ...
                     <span className="text-xs font-black text-white uppercase tracking-[0.2em] italic">Mosport</span>
                  </div>
                  <div className="flex items-center gap-6 border-l border-slate-800 pl-6">
                     <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest hover:text-white cursor-pointer transition-colors flex items-center gap-2">
                        <Activity size={12} /> Radar
                     </span>
                     <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest hover:text-white cursor-pointer transition-colors flex items-center gap-2">
         ...
         <main className="max-w-7xl mx-auto px-12 py-16 flex flex-col gap-12">
            ...
            <div className="w-full bg-[#0a111a] border border-slate-800 rounded-[2rem] p-8 flex items-center gap-10 relative overflow-hidden shadow-2xl">
               ...
               {/* PLAYER NUMBER BOX */}
               <div className="w-20 h-20 bg-[#070c14] rounded-2xl border border-cyan-500/50 flex items-center justify-center shadow-[0_0_30px_rgba(6,182,212,0.15)]">
                  <span className="text-4xl font-black text-white italic leading-none">17</span>
               </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
               ...
               <div className="lg:col-span-8 space-y-12">
                  <div className="flex items-center gap-3 px-2">
                     ...
                     <h2 className="text-xl font-black text-white italic uppercase tracking-tighter">Tactical Output [2026]</h2>
                  </div>
                  ...
                  {/* BIO-BATTERY PANEL (High-Density) */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                     <div className="bg-[#0a111a] border border-slate-800 rounded-[1.5rem] p-6 space-y-4 shadow-xl">
                        <div className="flex items-center gap-3">
                           <Battery size={16} className="text-red-400" />
                           <span className="text-[8px] font-black text-slate-600 uppercase tracking-[0.3em] italic">Bio-Battery & Status</span>
                        </div>
                        <div className="space-y-3">
                           <div className="flex justify-between items-end">
                              <span className="text-[8px] font-black text-slate-700 uppercase tracking-widest">Fatigue Load</span>
                              <span className="text-[10px] font-black text-red-500 italic">24% (Optimal)</span>
                           </div>
                     ...
                     <div className="bg-[#0a111a] border border-slate-800 rounded-[1.5rem] p-6 space-y-4 shadow-xl">
                        <div className="flex items-center gap-3">
                           ...
                           <span className="text-[8px] font-black text-slate-600 uppercase tracking-[0.3em] italic">Recent Momentum</span>
                        </div>
                        <div className="flex items-end gap-1.5 h-12">
                           {[40, 60, 45, 90, 80, 100].map((h, i) => (
                              <div key={i} className="flex-1 bg-cyan-400/20 hover:bg-cyan-400 transition-colors rounded-t-sm" style={{ height: `${h}%` }} />
                           ))}
                        </div>
                     </div>
                  </div>
               ...
               {/* RIGHT: BIO-RADAR (SVG - Compressed) */}
               <div className="lg:col-span-4 bg-[#0a111a] border border-slate-800 rounded-[2rem] p-8 shadow-2xl relative overflow-hidden h-fit sticky top-20">
                  <div className="flex items-center gap-3 mb-8">
                     <Target size={18} className="text-cyan-400" />
                     <h2 className="text-lg font-black text-white italic uppercase tracking-tighter">Bio-Athletic Radar</h2>
                  </div>
                  ...
                  <div className="mt-8 space-y-3">
                     <div className="flex justify-between items-center p-4 bg-slate-950 rounded-xl border border-slate-900">
                        <span className="text-[9px] font-black text-slate-700 uppercase tracking-widest">Composite Rating</span>
...
function StatCard({ label, value }: { label: string, value: string }) {
   return (
      <div className="bg-[#0a111a] border border-slate-800 rounded-[1.5rem] p-6 flex flex-col items-center justify-center gap-2 transition-all hover:border-cyan-500/30 hover:shadow-2xl group">
         <span className="text-[9px] font-black text-slate-700 uppercase tracking-[0.4em] italic group-hover:text-slate-500 transition-colors uppercase">{label}</span>
         <span className="text-3xl font-black text-white italic leading-none tracking-tighter shadow-2xl">{value}</span>
      </div>
   );
}
