...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 flex flex-col items-center overflow-x-hidden selection:bg-blue-500/30">
      <LiveTicker />

      {/* ESPN-Style Header */}
      <div className="w-full max-w-7xl pt-6 pb-4 px-4 sm:px-8">
        <div className="flex flex-col border-l-4 border-blue-500 pl-6">
          ...
          <h1 className="text-2xl sm:text-4xl font-black text-white italic uppercase tracking-[0.05em] leading-tight">
            MOSPORT <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">RADAR</span>
          </h1>
      ...
      {loading ? (
        <div className="flex-1 flex items-center justify-center p-40">
          <div className="animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-blue-500 shadow-[0_0_30px_rgba(59,130,246,0.3)]"></div>
        </div>
      ) : (
