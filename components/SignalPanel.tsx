  ...
  return (
    <div className={`p-5 rounded-lg border flex flex-col justify-between ${isTrueSignal ? 'bg-[#FF2E88]/10 border-[#FF2E88]' : 'bg-[#181A20] border-gray-800'}`}>
      <div className="flex justify-between items-start mb-4">
        <div>
          <h3 className="text-lg font-bold text-gray-100">{signal.match.home_team.team_name}</h3>
          <p className="text-xs text-gray-400">vs {signal.match.away_team.team_name}</p>
        </div>
