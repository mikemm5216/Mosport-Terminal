...
export default function LiveTicker() {
  ...
  return (
    <div className="w-full bg-[#12141A] border-y border-gray-800 overflow-hidden relative h-12 flex items-center">
       <div 
       ...
       >
          {scores.map((s, idx) => (
             <div key={idx} className="mx-8 flex items-center gap-3 text-sm">
                <span className="text-red-500 animate-pulse w-2 h-2 rounded-full"></span>
