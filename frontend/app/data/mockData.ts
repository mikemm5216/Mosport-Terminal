...
import type { ProviderRosterPlayer } from '../lib/providers/rosterProvider'
...
export interface Match {
  ...
  rosters?: {
    home: ProviderRosterPlayer[]
    away: ProviderRosterPlayer[]
  }
}
...
export const APR_22_MATCHES: Match[] = [
  ...
  },
  {
    ...
    perspective: "AWAY", tactical_label: "VULNERABILITY",
...
export const APR_21_MATCHES: Match[] = [
  {
    ...
    perspective: "HOME", tactical_label: "UNCERTAIN",
