export const TEAM_LOGOS: Record<string, string> = {
  ...
  NHL_ANA: '/logos/nhl/ana.png',
  NHL_BOS: '/logos/nhl/bos.png',
  NHL_BUF: '/logos/nhl/buf.png',
  NHL_CAR: '/logos/nhl/car.png',
  NHL_CBJ: '/logos/nhl/cbj.png',
  NHL_CGY: '/logos/nhl/cgy.png',
  NHL_CHI: '/logos/nhl/chi.png',
  NHL_COL: '/logos/nhl/col.png',
  NHL_DAL: '/logos/nhl/dal.png',
  NHL_DET: '/logos/nhl/det.png',
  NHL_EDM: '/logos/nhl/edm.png',
  NHL_FLA: '/logos/nhl/fla.png',
  NHL_LAK: '/logos/nhl/lak.png',
  NHL_MIN: '/logos/nhl/min.png',
  NHL_MTL: '/logos/nhl/mtl.png',
  NHL_NJD: '/logos/nhl/njd.png',
  NHL_NSH: '/logos/nhl/nsh.png',
  NHL_NYI: '/logos/nhl/nyi.png',
  NHL_NYR: '/logos/nhl/nyr.png',
  NHL_OTT: '/logos/nhl/ott.png',
  NHL_PHI: '/logos/nhl/phi.png',
  NHL_PIT: '/logos/nhl/pit.png',
  NHL_SEA: '/logos/nhl/sea.png',
  NHL_SJS: '/logos/nhl/sjs.png',
  NHL_STL: '/logos/nhl/stl.png',
  NHL_TBL: '/logos/nhl/tbl.png',
  NHL_TOR: '/logos/nhl/tor.png',
  NHL_UTA: '/logos/nhl/uta.png',
  NHL_VAN: '/logos/nhl/van.png',
  NHL_VGK: '/logos/nhl/vgk.png',
  NHL_WPG: '/logos/nhl/wpg.png',
  NHL_WSH: '/logos/nhl/wsh.png',
  ...
  UCL_ATM: '/logos/ucl/atm.png',
  UCL_AJX: '/logos/ucl/ajx.png',
  UCL_BEN: '/logos/ucl/ben.png',
  UCL_BVB: '/logos/ucl/bvb.png',
  UCL_INT: '/logos/ucl/int.png',
  UCL_JUV: '/logos/ucl/juv.png',
  UCL_MIL: '/logos/ucl/mil.png',
  UCL_NAP: '/logos/ucl/nap.png',
  UCL_POR: '/logos/ucl/por.png',
  UCL_PSG: '/logos/ucl/psg.png',
  UCL_RMA: '/logos/ucl/rma.png',
  UCL_BAR: '/logos/ucl/bar.png',
  UCL_BAY: '/logos/ucl/bay.png',
  UCL_SEV: '/logos/ucl/sev.png',
