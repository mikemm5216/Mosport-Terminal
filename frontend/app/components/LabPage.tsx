...
const LEAGUE_ROWS = [
  { league: "MLB", color: "#ef4444", matches: 2430, accuracy: 71.2, roi: 14.3, upsets: 68.9 },
  { league: "NBA", color: "#f97316", matches: 2180, accuracy: 69.8, roi: 11.8, upsets: 72.4 },
  { league: "EPL", color: "#22d3ee", matches: 1890, accuracy: 67.1, roi: 10.9, upsets: 70.3 },
  { league: "UCL", color: "#a78bfa", matches: 1540, accuracy: 68.3, roi: 13.4, upsets: 74.1 },
  { league: "NHL", color: "#34d399", matches: 1460, accuracy: 66.8, roi: 12.1, upsets: 69.8 },
]
    ...
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: isMobile ? "28px 16px 60px" : "44px 28px 80px" }}>
      ...
      <div style={{ marginBottom: 44 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
          ...
          <span style={{
            fontFamily: "var(--font-mono), monospace",
            fontSize: 9, fontWeight: 800, letterSpacing: "0.32em", color: "#22d3ee",
          }}>SYSTEM LAB</span>
          <span style={{ color: "#1e293b", fontFamily: "var(--font-mono), monospace", fontSize: 9 }}>//</span>
          <span style={{
            fontFamily: "var(--font-mono), monospace",
            fontSize: 9, fontWeight: 800, letterSpacing: "0.28em", color: "#334155",
          }}>ALGORITHMIC BACKTEST REPORT</span>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: isMobile ? "flex-start" : "flex-end", gap: 8 }}>
            <div style={{
              ...
              <span style={{
                width: 5, height: 5, background: "#22d3ee", borderRadius: "50%",
              ...
              <span style={{
                fontFamily: "var(--font-mono), monospace",
                fontSize: 9, fontWeight: 800, letterSpacing: "0.28em", color: "#22d3ee",
              }}>UPDATE FREQUENCY: MONTHLY</span>
            </div>
            <span style={{
              fontFamily: "var(--font-mono), monospace",
              fontSize: 9, color: "#334155", letterSpacing: "0.2em",
            }}>LAST GENERATED: APR 2026</span>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div>
            <div style={{
              fontFamily: "var(--font-mono), monospace",
              fontSize: isMobile ? 34 : 52, fontWeight: 800,
          ...
          {!isMobile && (
            <>
              ...
              <div>
                <div style={{
                  fontFamily: "var(--font-mono), monospace",
                  fontSize: 22, fontWeight: 800, color: "#a78bfa", letterSpacing: "-0.02em",
                }}>5 LEAGUES</div>
                <div style={{
                  fontFamily: "var(--font-mono), monospace",
                  fontSize: 9, fontWeight: 700, letterSpacing: "0.28em",
                  color: "#475569", marginTop: 5,
                }}>MLB · NBA · EPL · UCL · NHL</div>
              </div>
            </>
          )}
        </div>
      ...
      <div style={{
        ...
        gap: isMobile ? 20 : 56, flexWrap: "wrap",
        marginBottom: 56,
      }}>
        {RING_METRICS.map((m) => (
          <div key={m.label} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 14 }}>
            ...
            <div style={{
              fontFamily: "var(--font-mono), monospace",
              fontSize: 8, letterSpacing: "0.28em", color: "#1e293b", fontWeight: 700,
            }}>◆ ◆ ◆</div>
          </div>
        ))}
      </div>
        ...
        {STAT_BARS.map((s) => (
          <div key={s.label}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 7 }}>
              <span style={{
                fontFamily: "var(--font-mono), monospace",
                fontSize: 9, fontWeight: 700, letterSpacing: "0.24em", color: "#475569",
              }}>{s.label}</span>
              <span style={{
                fontFamily: "var(--font-mono), monospace",
                fontSize: 9, fontWeight: 800, letterSpacing: "0.1em", color: s.color,
              }}>{(s.value * 100).toFixed(1)}%</span>
            </div>
      ...
      {/* ── League breakdown ─────────────────────────────────────── */}
      <SectionTitle text="BREAKDOWN BY LEAGUE" />
      <div style={{
        ...
        <div style={{
          ...
          {["LEAGUE", "MATCHES", "ACCURACY", "ROI", "UPSETS"].map((h) => (
            <span key={h} style={{
              fontFamily: "var(--font-mono), monospace",
              fontSize: 8, fontWeight: 800, letterSpacing: "0.32em", color: "#334155",
            }}>{h}</span>
          ))}
        </div>
        ...
        {LEAGUE_ROWS.map((row, i) => (
          <div key={row.league} style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
              ...
              <span style={{
                fontFamily: "var(--font-mono), monospace",
                fontSize: 10, fontWeight: 800, letterSpacing: "0.2em", color: row.color,
              }}>{row.league}</span>
            </div>
            <span style={{
              fontFamily: "var(--font-mono), monospace",
              fontSize: 10, fontWeight: 700, color: "#64748b",
            }}>{row.matches.toLocaleString()}</span>
            <span style={{
              fontFamily: "var(--font-mono), monospace",
              fontSize: 10, fontWeight: 800, color: "#f8fafc",
            }}>{row.accuracy.toFixed(1)}%</span>
            <span style={{
              fontFamily: "var(--font-mono), monospace",
      ...
      <div style={{
        ...
        <div style={{
          fontFamily: "var(--font-mono), monospace",
          fontSize: 9, color: "#1e293b", letterSpacing: "0.2em", marginBottom: 10,
        }}>
          $ mosport-lab --run backtest --sample 9500 --output report
        </div>
        <div style={{
          fontFamily: "var(--font-mono), monospace",
          fontSize: 9, color: "#334155", letterSpacing: "0.14em", lineHeight: 2,
        }}>
          {">"} ALGORITHM: Bayesian ensemble (v4.1) + physio overlay<br />
          {">"} SAMPLE: 9,500 multi-sport fixtures · 5 leagues · 2022–2025<br />
          {">"} STATUS: <span style={{ color: "#34d399" }}>VALIDATION COMPLETE</span>
          {" "}· models passed significance threshold (p &lt; 0.01)<br />
          {">"} NEXT RUN: MAY 2026
        </div>
      </div>
